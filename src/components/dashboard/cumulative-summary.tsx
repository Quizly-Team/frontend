...
export default function CumulativeSummary({ data }: Props) {
  ...
  return (
    <div className="bg-white border border-[#dedede] rounded-[16px] p-[30px] max-md:p-[20px] w-[976px] max-lg:w-[904px] max-md:w-[250px] max-md:h-[298px] max-md:flex max-md:flex-col">
      ...
      <div className="flex items-center justify-center gap-[180px] max-md:flex-col max-md:gap-[20px] mb-[48px] max-md:mb-0 max-md:flex-1 max-md:justify-center">
        {/* 풀이 개수 */}
        <div className="flex items-center gap-[16px] max-md:w-[132px] max-md:h-[52px]">
          ...
          <div className="w-[62px] max-md:w-auto">
