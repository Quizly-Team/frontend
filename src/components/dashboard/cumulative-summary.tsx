...
export default function CumulativeSummary({ data }: Props) {
  ...
  return (
    <div className="bg-white border border-[#dedede] rounded-[16px] p-[30px] w-[976px] max-lg:w-[904px]">
      <h3 className="text-[20px] font-medium text-[#222] mb-[44px]">
        {currentMonth} 누적 학습 통계
      </h3>

      <div className="flex items-center justify-center gap-[180px] mb-[48px]">
        {/* 풀이 개수 */}
        <div className="flex items-center gap-[16px]">
          <div className="w-[54px] h-[54px] bg-[#eff6ff] rounded-[12px] flex items-center justify-center">
        ...
        {/* 전체 정답률 */}
        <div className="flex items-center gap-[16px]">
          <div className="w-[54px] h-[54px] bg-[#effdf4] rounded-[12px] flex items-center justify-center">
        ...
        {/* 오답 개수 */}
        <div className="flex items-center gap-[16px]">
          <div className="w-[54px] h-[54px] bg-[#fef3f2] rounded-[12px] flex items-center justify-center">
      ...
      <div className="border-t border-[#dedede] pt-[20px] -mx-[30px] px-[30px]">
