...
const LoginPage = ({ termsUrl, privacyUrl }: LoginPageProps = {}) => {
  ...
  const defaultTermsUrl =
    ...
    'https://www.notion.so/2480d810a5198028a431f471d3327ce0'
  const defaultPrivacyUrl =
    privacyUrl ||
    import.meta.env.VITE_PRIVACY_URL ||
    'https://www.notion.so/2480d810a51980b8831edc3dbb13333d'
          ...
          <div className="relative bg-white rounded-[24px] border border-[#dedede] w-[500px] max-md:w-full max-md:mx-4 px-[60px] max-md:px-[20px] py-[72px] max-md:py-[40px] flex flex-col items-center">
            ...
            <div className="w-full flex flex-col items-center gap-4 mb-[48px] max-md:mb-[24px]">
              ...
              <div className="relative w-full flex justify-center">
                ...
                >
                  <img src="/icon/kakao.svg" alt="Kakao" className="w-6 h-6" />
